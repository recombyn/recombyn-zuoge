...
Craft for **Animation / 动效 / UI motion** — calm, purposeful loops and one-shots. Static simple marks stay vector; complex still scenes use image; motion only when it has a job.

## Design thinking

| Ask | Aim |
|-----|-----|
| **Is motion needed?** | Explicit Animation / 动效 / loading ask — otherwise skip |
