...
def get_video_job(locale: LocaleDep, current_user: CurrentUser, job_id: str):
...
async def stream_video_job_events(request: Request, current_user: CurrentUser, job_id: str):
